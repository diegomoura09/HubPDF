...
PT_TRANSLATIONS = {
  ...
  "about_security_description": "Todos os arquivos são excluídos automaticamente, sem qualquer registro permanente.",
  ...
  "privacy_section_1_content": "O HubPDF não coleta, armazena nem compartilha arquivos enviados para processamento. Os documentos são excluídos automaticamente após o uso.",
  ...
  "privacy_section_3_content": "Os arquivos são processados com criptografia e exclusão imediata. Nenhum dado é armazenado permanentemente ou acessado por pessoas.",
